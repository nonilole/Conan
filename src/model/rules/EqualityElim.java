...
public class EqualityElim implements Rule{
	...
	public boolean verify(Box data, int rowIndex) {
		...
		//TODO:check that rowRef2-formula contains free instance of the objectId?
		Formula ref2 = data.getRow(rowRef2).getFormula();
		
		//check that rowRef1-formula is an Equality
		if(data.getRow(rowRef1).getFormula() instanceof Equality == false) return false;
		Equality eqRef = (Equality)data.getRow(rowRef1).getFormula();
